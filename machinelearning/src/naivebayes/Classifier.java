...
/**
 * implements the basic functionality for storing categories or features and can be used to calculate
 * basic probabilities both category and feature probabilities.
 *
 * @author wenlong
 *
 ...
 */
public abstract class Classifier<T, K> implements FeatureProbability<T, K> {
    ...
    public void reset() {
        ...
        this.totalCategoryCount =
                new Hashtable<K, Integer>(Classifier.INITIAL_CATEGORY_DICTIONARY_CAPACITY);
     ...
     */
    public float featureWeighedAverage(T feature, K category,
            FeatureProbability<T, K> calculator) {
        return this.featureWeighedAverage(feature, category,
    ...
    public float featureWeighedAverage(T feature, K category, FeatureProbability<T, K> calculator, float weight,
        ...
        final float basicProbability =
                (calculator == null) ? this.featureProbability(feature, category) : calculator.featureProbability(feature, category);
